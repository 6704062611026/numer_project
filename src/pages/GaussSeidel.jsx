...
function GaussSeidel() {
  ...
  const calculateGaussSeidel = () => {
    ...
    for (let iter = 0; iter < maxIterations; iter++) {
      ...
      const diff = x.map((val, i) => Math.abs(val - oldX[i]));
  ...
  return (
    <>
      ...
      >
        <h1 style={{ color: "#1e3a8a", textAlign: "center" }}>Gauss-Seidel Iteration Method</h1>
          ...
          <>
            ...
            <div style={{ width: 600, height: 400, margin: "0 auto" }}>
              <Plot
                ...
                layout={{
                  title: {
                    text: "Gauss-Seidel: Final Solution",
                    font: { color: "#1e3a8a" },
                  },
                  xaxis: {
                    title: { text: "Variable", font: { color: "#1e3a8a" } },
                  },
                  yaxis: {
